                        ...
                        return (
                            <Form>
                                <div className="form-control">
                                    <label className="label" htmlFor="username">
                                        <span className="label-text">Username <label className="text-red-500">*</label></span>
                                    </label>
                                    <Field
                                        id="Username"
                                        type="text"
                                        ...
                                        className={`input input-group-lg input-bordered `}
                                    />
                                ...
                                <div className="form-control">
                                    <label className="label" htmlFor="passwordConfirm">
                                        <span className="label-text">
                                            Password Confirmation <label className="text-red-500">*</label>
                                        </span>
                                    </label>
                                    <Field
                                        type="password"
                            ...
                            `}
                                ...
                                <button
                                    ...
                                    className={`p-2 mt-6 rounded-lg  ${loading || !formik.isValid ? " p-2 btn-disabled" : " bg-[#2e6a5c]"
                                        } w-full`}
                                >
                                    {loading ? (
                                        <p className="text-gray-200 animate animate-pulse">
                                            Loading...
                                        </p>
                                    ) : (
